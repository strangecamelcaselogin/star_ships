...
class SpaceMap:
    ...
    def init_tiles(self):
        ...
        for c in self.contours[0]:
            ...
            x_tile = int(c[0][0] // settings.TILE_SIZE)  # номер столбца в матрице тайлов, в котором находится точка контура
            y_tile = int(c[0][1] // settings.TILE_SIZE)  # номер строки в матрице тайлов, в котором находится точка контура
